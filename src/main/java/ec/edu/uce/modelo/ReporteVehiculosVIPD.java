...
public class ReporteVehiculosVIPD {
	...
	public ReporteVehiculosVIPD() {
	}

	public ReporteVehiculosVIPD(Vehiculo vehiculo, BigDecimal valorIVA, BigDecimal valorTotalAPagar) {
